...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "ahmed.marwan.dev@gmail.com",
    href: "mailto:ahmed.marwan.dev@gmail.com",
  },
  {
    icon: Phone,
    label: "WhatsApp",
                ...
                {contactInfo.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="font-medium text-sm sm:text-base break-all sm:break-normal">{item.value}</div>
                    </div>
                  </a>
                ))}
              </div>
